        ...
        namelist.map((name, index) => {
          datalist.map((item, index) => {
            if(name == item.id){
              ...
              console.log("Origin : " + item.price_change_percentage_24h);
